...
一个 Obsidian 插件：把文件浏览器中的文件夹点击操作转换成左侧边栏里的温暖复古风卡片流。你可以按文件夹浏览笔记，点击卡片打开笔记，并在探索过程中保持当前上下文。
...
1. 打开 **文件浏览器** 并点击任意文件夹。
2. **左侧边栏** 会出现一个卡片流，显示该文件夹中的笔记。
3. 点击任意卡片即可打开对应笔记。
4. 当你在编辑器中切换笔记时，对应卡片也会自动被选中。

## 功能特性

- **以文件夹为驱动的浏览。** 在文件浏览器中点击任意文件夹，即可在左侧边栏加载对应的卡片流。
...
- **以文件夹为入口。** 卡片流由文件浏览器中的文件夹点击触发，不提供独立于文件夹选择之外的单独浏览模式。
