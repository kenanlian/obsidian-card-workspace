...
**Constitution**: Include mandatory tasks for performance impact checks, privacy/network
decisions, lifecycle cleanup, and modular boundary validation.
...
- [ ] T003 [P] Capture constitution gates (performance, privacy, native feel, modular design)
...
- [ ] T005 Setup core architecture boundaries (domain logic vs UI vs platform adapters)
- [ ] T006 [P] Establish performance instrumentation or profiling checkpoints
- [ ] T007 [P] Define privacy/network guardrails and offline fallback behavior
- [ ] T008 [P] Setup lifecycle-safe registration/cleanup infrastructure
...
- [ ] T020 [US1] Verify main-thread responsiveness and cleanup behavior for new listeners
...
- [ ] TXXX Privacy/network request audit and consent UX verification
